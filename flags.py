...
tf.app.flags.DEFINE_string('senti_model_dir', '../style/model', 'sentiment model dir')
...
tf.app.flags.DEFINE_boolean('pos', False, 'positive or negative')

tf.app.flags.DEFINE_integer('g', 400, 'style gradient weight')
tf.app.flags.DEFINE_integer('l2', 25, 'L2 norm gradient weight')
